...
describe('ErrorBoundary', () => {
  ...
  describe('wrap', () => {
    ...
    it('should wrap a function and catch asynchronous errors', async () => {
      ...
      const wrappedFunction = errorBoundary.wrap(faultyAsyncFunction, 'async-test-context');
  ...
  describe('handleError', () => {
    it('should log errors and call the error callback', () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith('[Plugin test-plugin] Error in test-context: Test error');
    ...
    it('should handle errors in the error callback', () => {
      ...
      const errorBoundaryWithFaultyCallback = new ErrorBoundary('test-plugin', faultyCallback);
      const error = new Error('Test error');
      
      (errorBoundaryWithFaultyCallback as any).handleError(error, 'test-context');
